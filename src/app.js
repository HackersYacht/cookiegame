...
var imgRes = [res.char1, res.char2, res.char7, res.char4,
              res.char5, res.char6, res.char7]//hiding 3
var This;
var pickedTiles = []
var size;
var scoreText;
...
var HelloWorldLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        size = cc.winSize;
        This = this;
        /*var tile = new cc.Sprite(res.char1);
        this.addChild(tile, 0)
        tile.setPosition(cSize, size.height-cSize);
        var tile1 = new cc.Sprite(res.char1);
        this.addChild(tile1, 0)
        tile1.setPosition(cSize+(cSize*2), size.height-(cSize));*/
        var gradient  = cc.LayerGradient.create(
          cc.color(178,254,250,255), cc.color(14, 210, 247, 255))
...
var listener = cc.EventListener.create({
  ...
  onTouchBegan: function(touch, event){
    if (pickedTiles.length < 2){
      ...
      var targetRectangle =
        cc.rect(0, 0, targetSize.width, targetSize.height)
